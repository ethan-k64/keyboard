...
function keyPressed() {
  ...
  if (key == ',') {
    ...
    comma.setADSR(0, 0.3, 0.2, 0);
    comma.setRange(0.1, 0);
    comma.play();
  ...
  if (key == '.') {
    ...
    period.setADSR(0, 0.3, 0.2, 0);
    period.setRange(0.1, 0);
    period.play();
  ...
  if (key == '/') {
    ...
    slash.setADSR(0, 0.3, 0.2, 0);
    slash.setRange(0.1, 0);
    slash.play();
  ...
  if (key == '3') {
    ...
    three.setADSR(0, 0.3, 0.2, 0);
    three.setRange(0.1, 0);
    three.play();
  ...
  if (key == '7') {
    ...
    seven.setADSR(0, 0.3, 0.2, 0);
    seven.setRange(0.1, 0);
    seven.play();
  ...
  if (key == ';') {
    ...
    semicolin.setADSR(0, 0.3, 0.2, 0);
    semicolin.setRange(0.1, 0);
    semicolin.play();
  ...
  if (key == '\'') {
    ...
    quote.setADSR(0, 0.3, 0.2, 0);
    quote.setRange(0.1, 0);
    quote.play();
